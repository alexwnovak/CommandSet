namespace CommandSet.DataExchangeService
{
   partial class ProjectInstaller
   {
      ...
      private void InitializeComponent()
      {
         ...
         // _serviceInstaller
         // 
         this._serviceInstaller.Description = "The Command Set Data Exchange Service coordinates data between tools. It can rece" +
    "ive and retain data for use between commands.";
         this._serviceInstaller.DisplayName = "Data Exchange Service";
         this._serviceInstaller.ServiceName = "DataExchangeService";
